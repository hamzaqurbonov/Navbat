...
public class BarberActivity extends AppCompatActivity {
    ...
    private EditText edit_hour_id_barber, edit_minut_id_barber, barberNameEditText, barberLocationEditText, barberDescEditText;
    private Button add_hour_id_barber;
...
//        });
        ...
        edit_hour_id_barber = findViewById(R.id.edit_hour_id_barber);
        edit_minut_id_barber = findViewById(R.id.edit_minut_id_barber);
        add_hour_id_barber  = findViewById(R.id.add_hour_id_barber);
        recycler  = findViewById(R.id.recycler_barber);
        ...
        add_hour_id_barber.setOnClickListener(v -> {
            WriteDb();
            activityList.clear();
            ReadDb();
    ...
    private void WriteDb() {
        ...
        String hourStr = edit_hour_id_barber.getText().toString();
        String hourMinut = edit_minut_id_barber.getText().toString();
        ...
        if (starMinut>=60) {
            ...
            edit_hour_id_barber.setText("");
            edit_minut_id_barber.setText("");
        }else {
        ...
        db.collection("Barbers").document(uid).collection("customer").get()
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        adapter = new BarberAdapter(BarberActivity.this, activityList);
